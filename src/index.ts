...
let cage1: Cage = { biom: "tundra", square: 100, hasReservoir: true };
let cage2: Cage = { biom: "dessert", square: 100, hasReservoir: false };
let cage3: Cage = { biom: "forest", square: 100, hasReservoir: true };
